...
batch_size = 32  # num of sequences processing in parallel
block_size = 8  # maximum content length of predictions
max_iters = 5000
eval_interval = 300
learning_rate = 1e-3
...
for iter in range(max_iters):
    ...
    # every once ina while evaluate the loss on train and val sets
